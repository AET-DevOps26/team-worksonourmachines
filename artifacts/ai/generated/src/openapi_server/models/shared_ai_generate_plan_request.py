...
class SharedAiGeneratePlanRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SharedAiGeneratePlanRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SharedAiGeneratePlanRequest from a dict"""
        if obj is None:
            return None
