...
class SharedAiGeneratePlanResponse(BaseModel):
    """
    SharedAiGeneratePlanResponse
    """ # noqa: E501
    learning_goal_id: StrictStr = Field(alias="learningGoalId")
    suggestions: List[SharedAiPlanSuggestion]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SharedAiGeneratePlanResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SharedAiGeneratePlanResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "suggestions": [SharedAiPlanSuggestion.from_dict(_item) for _item in obj.get("suggestions")] if obj.get("suggestions") is not None else None
        })
        return _obj
