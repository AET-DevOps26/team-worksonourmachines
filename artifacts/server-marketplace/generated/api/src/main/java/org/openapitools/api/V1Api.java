...
public interface V1Api {
    ...
    default ResponseEntity<SharedMarketplaceModuleDetail> createAdminModule(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"code\" : \"code\", \"topics\" : [ { \"difficultyHint\" : \"difficultyHint\", \"name\" : \"name\", \"description\" : \"description\", \"id\" : \"id\" }, { \"difficultyHint\" : \"difficultyHint\", \"name\" : \"name\", \"description\" : \"description\", \"id\" : \"id\" } ], \"difficultyHint\" : \"difficultyHint\", \"description\" : \"description\", \"id\" : \"id\", \"title\" : \"title\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<List<SharedMarketplaceModuleDetail>> listAdminModules(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"code\" : \"code\", \"topics\" : [ { \"difficultyHint\" : \"difficultyHint\", \"name\" : \"name\", \"description\" : \"description\", \"id\" : \"id\" }, { \"difficultyHint\" : \"difficultyHint\", \"name\" : \"name\", \"description\" : \"description\", \"id\" : \"id\" } ], \"difficultyHint\" : \"difficultyHint\", \"description\" : \"description\", \"id\" : \"id\", \"title\" : \"title\" }, { \"code\" : \"code\", \"topics\" : [ { \"difficultyHint\" : \"difficultyHint\", \"name\" : \"name\", \"description\" : \"description\", \"id\" : \"id\" }, { \"difficultyHint\" : \"difficultyHint\", \"name\" : \"name\", \"description\" : \"description\", \"id\" : \"id\" } ], \"difficultyHint\" : \"difficultyHint\", \"description\" : \"description\", \"id\" : \"id\", \"title\" : \"title\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
