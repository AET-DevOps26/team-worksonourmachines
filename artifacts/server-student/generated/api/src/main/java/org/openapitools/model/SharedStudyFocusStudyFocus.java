...
@Schema(name = "Shared.StudyFocus.StudyFocus", description = "Ratings for study-skill dimensions on a 1 (low) to 5 (high) scale.")
...
public class SharedStudyFocusStudyFocus {
  ...
  @Schema(name = "memorization", description = "Recalling definitions, formulas, and terminology.", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull @Min(value = 1) @Max(value = 5) 
  @Schema(name = "formalReasoning", description = "Proofs, logic, derivations, and symbolic manipulation.", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull @Min(value = 1) @Max(value = 5) 
  @Schema(name = "conceptualUnderstanding", description = "Building mental models and understanding why concepts work.", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull @Min(value = 1) @Max(value = 5) 
  @Schema(name = "problemSolving", description = "Applying theory to exercises and exam-style problems.", requiredMode = Schema.RequiredMode.REQUIRED)
